      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {projects.map((project, index) => (
            ...
            >
              {index === 0 && <MatrixBackground image="https://i.ibb.co/qFRGLLzc/project1.png" brightness={0.3} />}
              {index === 1 && <MatrixBackground image="https://i.ibb.co/kgcR6H2k/project2.png" brightness={0.3} />}
              {index === 2 && <MatrixBackground image="https://i.ibb.co/mVBMJDY8/project3.png" brightness={0.3} />}
              {index === 3 && <MatrixBackground image="https://i.ibb.co/h5gZYJ2/project4.png" brightness={0.3} />}
              {index === 4 && null}
